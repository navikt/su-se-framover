...
| [`security-owasp`](skills/security-owasp/SKILL.md) | Skillen formulerer generelle OWASP-råd som absolutte regler. Dette er ikke automatisk vedtatte frontendregler og kan plassere autorisasjonsansvar i BFF-en. | Bruk relevante browser-, TypeScript-, Node/BFF-, auth-, input-, logging-, feil- og supply-chain-råd. Autorisasjon og domeneoverganger forblir backendansvar. Ikke gjør bred Actions-omlegging uten separat beslutning. |
