...
import { groupByEq, groupWhile, spanLeftWithIndex } from '~src/utils/array/arrayUtils';
...
describe('groupWhile', () => {
    it('puts all elements in the same group when predicate is true', () => {
        const res = pipe(
            [1, 2, 3, 4, 5],
            groupWhile(() => true),
        );
