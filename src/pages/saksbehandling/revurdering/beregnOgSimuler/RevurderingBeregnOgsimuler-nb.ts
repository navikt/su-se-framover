export default {
    ...
    'beregnOgSimuler.ny': 'Beregn og simuler',

    'beregnOgSimuler.beregner': 'Beregner og simulerer...',
    'beregnOgSimuler.utsettTilbakekreving': 'Skal tilbakekreving utsettes?',
    'beregnOgSimuler.helpText': 'Ny innsending av data gjøres ved beregning og simuler knappen',
