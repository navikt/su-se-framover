...
function Saksoversikt() {
    ...
    return (
        <div className="saksoversikt">
            <div className="mainContent" style={{display: 'flex'}}>
                <div style={{display:'flex', flexDirection: 'column', width: '100%'}}>
                    ...
                    <div className="mainSection" style={{marginBottom: '1em'}}>
                        <div className="NAVBar" style={{border: 'solid 1px', backgroundColor: 'rgb(233, 231, 231)', padding: '0.5em'}}>
                            <ul style={{display: 'flex', justifyContent: 'space-around'}}>
                                <li style={{fontWeight: 'bold'}} onClick={() => setPageToRender(1)}>Oversikt</li>
                                <li style={{fontWeight: 'bold'}} onClick={() => setPageToRender(2)}>Aktiv Stønadsperiode</li>
                                <li style={{fontWeight: 'bold'}} onClick={() => setPageToRender(3)}>tidligere stønadsperioder</li>
                            </ul>
                        </div>
                    </div>
            ...
            <Hovedknapp style={{marginRight: '1em'}} onClick={() => dispatch(submitSaksoversikt(state))}>Lagre</Hovedknapp>
            <Hovedknapp onClick={() => history.push('/vilkarsprov', (sak = { sak }))}>Til vikkårsprøving</Hovedknapp>
            <div>
                {
                    submitRequest ? <AlertStripeSuksess>{submitRequest}</AlertStripeSuksess> : ""
                }
            </div>
        </div>
    );
