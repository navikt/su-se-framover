        ...
        <TextProvider messages={{ [Languages.nb]: messages }}>
            <div className={sharedStyles.container}>
                <Ekspanderbartpanel
                    ...
                    tittel={<FormattedMessage id="panel.tittel.uførevedtak" />}
                >
                    <OppsummeringsFelt
                        label={<FormattedMessage id="input.uførevedtak.label" />}
                        verdi={søknadFraStore.harUførevedtak
                            ? "Ja"
                ...
                <Ekspanderbartpanel
                    className={styles.ekspanderbarOppsumeringSeksjon}
                    tittel={<FormattedMessage id="panel.tittel.flyktningstatus" />}
                >
                    <OppsummeringsFelt
                        label={<FormattedMessage id="input.flyktning.label" />}
                        verdi={søknadFraStore.flyktningstatus.erFlyktning
                            ? "Ja"
                    ...
                    <OppsummeringsFelt
                        ...
                        verdi={søknadFraStore.flyktningstatus.harOppholdstillatelse
                            ? "Ja"
                ...
                <Ekspanderbartpanel
                    className={styles.ekspanderbarOppsumeringSeksjon}
                    tittel={<FormattedMessage id="panel.tittel.boOgOpphold" />}
                >
                    <OppsummeringsFelt
                        label={<FormattedMessage id="input.opphold-i-norge.label" />}
                        verdi={søknadFraStore.boOgOpphold.borOgOppholderSegINorge
                            ? "Ja"
                    ...
                    <OppsummeringsFelt
                        ...
                        verdi={søknadFraStore.boOgOpphold.borPåFolkeregistrertAdresse
                            ? "Ja"
                    ...
                    <OppsummeringsFelt
                        ...
                        verdi={søknadFraStore.boOgOpphold.bosituasjon === Bosituasjon.BorAleneEllerMedBarnUnder18
                    ...
                    <OppsummeringsFelt
                        ...
                        verdi={søknadFraStore.boOgOpphold.delerBoligMedAndreVoksne
                            ? "Ja"
                ...
                <Ekspanderbartpanel
                    className={styles.ekspanderbarOppsumeringSeksjon}
                    tittel={<FormattedMessage id="panel.tittel.dinFormue" />}
                >
                    <OppsummeringsFelt
                        label={<FormattedMessage id="input.harFormue.label" />}
                        verdi={søknadFraStore.formue.harFomue
                            ? "Ja"
                            : søknadFraStore.formue.harFomue === false
                                ? "Nei"
                                : "Ubesvart"}
                    />
                    {
                        søknadFraStore.formue.harFomue ? <OppsummeringsFelt
                            label={<FormattedMessage id="input.oppgiBeløp.label" />}
                            verdi={søknadFraStore.formue.belopFormue ? søknadFraStore.formue.belopFormue : "Ubesvart"}
                        /> : ""
                    }

                    <OppsummeringsFelt
                        label={<FormattedMessage id="input.eierDuBolig.label" />}
                        verdi={søknadFraStore.formue.eierBolig
                            ? "Ja"
                    ...
                    <OppsummeringsFelt
                        ...
                        verdi={søknadFraStore.formue.harDepositumskonto
                            ? "Ja"
                ...
                <Ekspanderbartpanel
                    className={styles.ekspanderbarOppsumeringSeksjon}
                    tittel={<FormattedMessage id="panel.tittel.dinInntekt" />}
                >
                    <OppsummeringsFelt
                        label={<FormattedMessage id="input.harInntekt.label" />}
                        verdi={søknadFraStore.inntekt.harInntekt
                            ? "Ja"
                    ...
                    />
                    {
                        søknadFraStore.inntekt.harInntekt ? <OppsummeringsFelt
                    ...
                    <OppsummeringsFelt
                        ...
                        verdi={søknadFraStore.inntekt.mottarPensjon
                            ? "Ja"
                    ...
                    <OppsummeringsFelt
                        ...
                        verdi={søknadFraStore.inntekt.harMottattSosialstønad
                            ? "Ja"
                ...
                <Ekspanderbartpanel
                    className={styles.ekspanderbarOppsumeringSeksjon}
                    tittel={<FormattedMessage id="panel.tittel.reiseTilUtlandet" />}
                >
                    <OppsummeringsFelt
                        label={<FormattedMessage id="input.harReistSiste90.label" />}
                        verdi={søknadFraStore.utenlandsopphold.harReistTilUtlandetSiste90dager
                            ? "Ja"
                    ...
                    <OppsummeringsFelt
                        ...
                        verdi={søknadFraStore.utenlandsopphold.skalReiseTilUtlandetNeste12Måneder
                            ? "Ja"
