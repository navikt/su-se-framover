export default {
    ...
    'viktigÅVite.ingress': 'Viktig å vite før du fyller ut',
    'viktigÅVite.blirIkkeLagret':
        'Går du ut av søknaden før du er ferdig med å fylle den ut, blir ikke det du har skrevet lagret. Derfor må du ha alle opplysningene du trenger lett tilgjengelig, for eksempel informasjon om inntekt og formue for deg og ektefellen eller samboeren din.',
