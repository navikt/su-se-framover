...
export const viewIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24">
        <g>
            <path fill='none' stroke='#000000' strokeLinecap='round' strokeLinejoin='round' strokeMiterlimit='10' d="M23.5,12
			c0,0-5.148,6.5-11.5,6.5S0.5,12,0.5,12S5.648,5.5,12,5.5S23.5,12,23.5,12z"/>

            <circle fill='none' stroke='#000000' strokeLinecap='round' strokeLinejoin='round' strokeMiterlimit='10' cx="12" cy="12" r="4"/>
        </g>
    </svg>
)
...
export const EmailIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <g stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" fill="none">
            <path d="M22.5 17.012c0 .828-.672 1.5-1.5 1.5h-18c-.828 0-1.5-.672-1.5-1.5v-11c0-.829.672-1.5
...
export const DialogIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <g stroke="#000" strokeLinejoin="round" strokeMiterlimit="10" fill="none">
            <path d="M7.919 23.5h7.581v-4.5c0-.5-3-2-5.5-3v-2s1-.35
...
export const PencilIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
        <g stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" fill="none">
            <path d="M7.31 21.675l-6.466 1.517 1.517-6.465 15.6-15.602c.781-.781 2.049-.781 2.829
...
export const BankNote = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <g stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" fill="none">
            ...
            <path d="M21.513 14.5c0 1.105-.896 2-2 2h-15c-1.104
...
export const ReceiptIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <g stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" fill="none">
            <path d="M4.513 23.5l2-2 2 2 2-2 2 2 2-2 2 2 2-2 2 2v-23l-2 2-2-2-2 2-2-2-2 2-2-2-2 2-2-2zM7.513
...
export const CalculatorIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24">
        <g stroke="#000" strokeLinejoin="round" strokeMiterlimit="10" fill="none">
            <path d="M20.513 21c0 1.375-1.125 2.5-2.5 2.5h-13c-1.375 0-2.5-1.125-2.5-2.5v-18c0-1.375
...
export const CreditCardIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <g stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" fill="none">
            <path d="M23.513 17.5c0 1.104-.896 2-2 2h-19c-1.104 0-2-.896-2-2v-10c0-1.104.896-2 2-2h19c1.104 0 2 .896
...
export const CheckListIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24">
    <g stroke="#000" strokeLinejoin="round" strokeMiterlimit="10" fill="none">
      ...
      <path strokeLinecap="round"
      d="M3.5 7.5l2 2 5-5M3.5 16.5l2 2 5-5M12.5 8.5h8M12.5 17.5h8"/>
    </g>
  </svg>
)
...
export const IDCard = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <g stroke="#000" strokeLinejoin="round" strokeMiterlimit="10" fill="none">
            <path d="M.5 3.5v17h4v-1.5c0-.962.787-1.75 1.75-1.75.962 0 1.75.788 1.75
...
export const PhoneIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <path stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10"
              ...
              0l-.817.818c-2.69-2.205-5.309-4.824-7.513-7.515l.818-.816z" fill="none"/>
    </svg>
)
...
export const StackedCoinsIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <g stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" fill="none">
            ...
            <path d="M15.513 2.5v3c0 1.104-3.357 2-7.5 2-4.142 0-7.5-.896-7.5-2v-3M15.513 5.5v3c0 1.104-3.357 2-7.5
            2-4.142 0-7.5-.896-7.5-2v-3"/><ellipse cx="16.013" cy="15.5" rx="7.5" ry="2"/>
            <path d="M23.513 15.5v3c0 1.104-3.357 2-7.5 2-4.142 0-7.5-.896-7.5-2v-3M23.513 18.5v3c0 1.104-3.357
...
export const WorldIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <g stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" fill="none">
            ...
            <path d="M20.5 4.256s-.5 2.744-2.5 3.744c-2-.5-4 1-3.5 1l1 2c.5.5 1.5 0 1.5 0 1.25 1.25-2
...
export const AirplaneIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <g stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" fill="none">
            <path d="M20.734 5.055l-13.668 5.945-3-1.5-3.5 1.5 4.5 4.5 7.5-3-3 8 4-2 4-8 4.697-1.75c1.021-.423
...
export const LocationPinIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    <g stroke="#000"
      ...
      strokeMiterlimit="10"
      fill="none">
        <path d="M19.5 8c0 4.144-7.5 15.5-7.5 15.5s-7.5-11.356-7.5-15.5c0-4.142
