export default {
    ...
    'alert.advarsel.avkorting':
        'Søkeren har en utestående avkorting (pga for langt utenlandsopphold) som vil bli automatisk trukket fra etter du har lagt inn fradrag og startet beregningen.',
