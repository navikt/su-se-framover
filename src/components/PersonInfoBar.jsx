		...
		<Ekspanderbartpanel tittel={
			...
			<div className="flex-container" style={bar}>
				...
				<div style={element}>
					...
					{
						person.statsborgerskap.map((statsborgerskap, index) => {
							return(
								<>
								<Normaltekst>{statsborgerskap.land} ({statsborgerskap.fom})</Normaltekst>
								</>
							)
						})
					}
				...
				<div style={element}>
					...
					<Normaltekst>{person.foedsel.foedested}, {person.foedsel.foedeland}</Normaltekst>
				...
				<div style={element}>
					<Undertittel>Oppholdstillatelse</Undertittel>
					{
						person.opphold.map((opphold, index) => {
							return(
								<>
								<Normaltekst>{opphold.type} ({opphold.fom}-{opphold.tom})</Normaltekst>
								</>
							)
						})
					}
				...
				<div style={element}>
					...
					{
						person.folkeregisterpersonstatus.map((status, index) => {
							return(
								<>
								<Normaltekst>{status.status} ({status.fom}-{status.tom})</Normaltekst>
								</>
							)
						})
					}
