...
const messages: { [key in RevurderingErrorCodes]: string } & { [key: string]: string } = {
    [Generell.FANT_IKKE_PERSON_ELLER_SAKSBEHANDLER_NAVN]: 'Fant ikke person eller saksbehandlers navn',
    [Generell.FANT_IKKE_TIDLIGERE_GRUNNLAGSDATA]: 'Fant ikke tidligere grunnlagsdata',
    [Generell.FANT_IKKE_VEDTAK]: 'Fant ikke vedtak',
    ...
    [Generell.REVURDERINGSÅRSAK_UGYLDIG_BEGRUNNELSE]: 'Ugyldig begrunnelse for revurdering',
    [Generell.REVURDERINGSÅRSAK_UGYLDIG_ÅRSAK]: 'Ugyldig årsak for revurdering',
    [Generell.KUNNE_IKKE_SLÅ_OPP_EPS]: 'Kunne ikke slå opp ektefelle eller samboer i PDL',
    [Generell.UKJENT_FEIL]: 'Ukjent feil',
    [Generell.INGENTING_Å_REVURDERE_I_PERIODEN]: 'Fant ingen vedtak som kan revurderes for angitt periode',
    ...
    [Formue.FORMUELISTE_KAN_IKKE_VÆRE_TOM]: '',
    ...
    [Gjenopptak.KUNNE_IKKE_OPPRETTE_REVURDERING_FOR_GJENOPPTAK]: 'Kunne ikke opprette revurdering for gjenopptak',
