export default {
    ...
    'forhåndsvarsel.ikke.varslet': 'Kan ikke beslutte forhåndsvarsel. Revurderingen er ikke forhåndsvarslet',
    ...
    'beregning.kan.ikke.velge.siste.måned.ved.nedgang':
        'Kan ikke velge siste måned av stønadsperioden ved nedgang i stønaden',
    'beregning.ugyldig.beregnignsgrunnlag': 'Ugyldig beregningsgrunnlag',
    'beregning.ikke.lov.eps.fradrag.uten.eps': 'Kan ikke ha fradrag knyttet til EPS når bruker ikke har EPS',
