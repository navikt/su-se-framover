export enum ApiErrorCode {
    ...
    HISTORISK_INFOTRYGD_REVURDERING_VERSJONSKONFLIKT = 'historisk_infotrygd_revurdering_versjonskonflikt',
    HISTORISK_INFOTRYGD_UTBETALINGSDESIGN_IKKE_AVKLART = 'historisk_infotrygd_utbetalingsdesign_ikke_avklart',
    ...
    KUNNE_IKKE_LAGRE_HISTORISK_INFOTRYGD_REVURDERING = 'kunne_ikke_lagre_historisk_infotrygd_revurdering',
    ...
    UGYLDIG_HISTORISK_INFOTRYGD_GRUNNLAG = 'ugyldig_historisk_infotrygd_grunnlag',
    UGYLDIG_HISTORISK_INFOTRYGD_REVURDERING_ID = 'ugyldig_historisk_infotrygd_revurdering_id',
