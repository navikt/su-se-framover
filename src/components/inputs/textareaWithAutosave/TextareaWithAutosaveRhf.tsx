...
// Brukes der felt som skal autolagres er under react hook forms
const TextareaWithAutosaveRhf = <T extends object, U extends FieldValues>(props: {
    textarea: {
        name: Path<U>;
        label: string;
        control: Control<U>;
...
export default TextareaWithAutosaveRhf;
